   ...
   <div class="container">
      <div class="row shadow-sm p-3 mb-4" style="background-color:#3e454f; color: #fff;">
         <div class="col-12 text-center">
            <h3> <b>REPORTE POR MICROREGIÓN</b> </h3>
         </div>
      </div>
   </div>
</section>
   ...
   <div class="container">
      <div class="row shadow-sm bg-white p-3 mb-4">
          <div class='col-12' style="display:none">
            ...
            <div class="col-3">
               <select  id="cmb_micro" class="form-control" name="cmb_micro"  >
                  <option value=''> (SELECCIONA UNA MICROREGIÓN) </option>
                  <?php
                     foreach($data_micro as $dat){
                     ?>
                  <option value="<?php echo $dat->idregion ?>"> <?php echo $dat->nombre_micro ?></option>
                  <?php
                     }
                     ?>
               </select>
            ...
            <div class="col-3">
               <button type="button" class="form-control btn btn-sm btn-primary" id="btnBuscar" onclick='getMicroregion("<?= base_url("get_microregion") ?>")' >
