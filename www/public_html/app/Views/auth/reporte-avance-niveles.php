...
<section>
  <div class="container">
    <div class="row shadow-sm bg-white p-3 mb-4">
        ...
        <div class="col-8">
        <select  id="cmbUgel" class="form-control" name="cmbUgel"> 
        ...
        <div class="col-4">
        <button type="button" class="form-control btn btn-sm btn-primary" id="btnBuscar" onclick='getAvanceNiveles("<?= base_url("get_avance") ?>")' >
  ...
  <div class="container" id="contenedor" style='display:none;'>
    <div class="row shadow-sm bg-white p-3 mb-3" id='tabla_exportar'>
      <div class="table-responsive">
          <div class="col-sm-12"><h2 class="text-center">PERIODO 2022-1</h2></div>
        <div class="col-sm-12">
        <div id="cuadro_1-1"></div>
        </div>
          <div class="col-sm-12"><h2 class="text-center">PERIODO 2022-2</h2></div>
          <div class="col-sm-12">
