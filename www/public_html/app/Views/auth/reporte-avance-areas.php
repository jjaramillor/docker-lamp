...
<section>
  <div class="container">
    <div class="row shadow-sm bg-white p-3 mb-4">
        ...
        <div class="col-4">
        <select  id="cmbColegio" class="form-control" name="cmbColegio" > 
        ...
        <div class="col-4">
        <button type="button" class="form-control btn btn-sm btn-primary" id="btnBuscar" onclick='getAvanceAreas("<?= base_url("get_avance_areas") ?>")' >
    ...
    <div class="row shadow-sm bg-white p-3 mb-3" id='tabla_exportar'>
      <div class="table-responsive">
          <div class="row">
              ...
              <div class="col-sm-5">PERIODO 2022-1</div>
              <div class="col-sm-1"></div>
              <div class="col-sm-5">PERIODO 2022-2</div>
          </div>
