    ...
    <div class="row shadow-sm bg-white p-3 mb-4">
      <div class="col-10">
        <div class="row">
          ...
          <div class='col-3'>
            <select  id='cmb_area_avance'  class='form-control' > 
      ...
      <div class="col-12">
        <div class="row">
          <div class="col-12">
            <button type="button" class="form-control btn btn-sm btn-primary" id="btnBuscar" onclick='getEscala("<?= base_url("get_escala") ?>")' ><i class='fas fa-search'></i> Buscar </button>
          </div>
        </div>
      </div>
    </div>
