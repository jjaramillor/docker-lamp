...
class UserModel extends Model
{
	...
	protected $allowedFields = [
		'cod_colegio','name', 'firstname', 'lastname', 'email', 'new_email', 'password', 'password_confirm','activate_hash', 'reset_hash', 'reset_expires','idperfil', 'active'
	];
	...
	protected $dynamicRules = [
		'registration' => [
			...
			'cod_colegio' 		=> 'required|min_length[1]',
			'name' 			=> 'required|is_unique[users.name,id,{id}]',
			'idperfil'			=> 'required|min_length[1]',
